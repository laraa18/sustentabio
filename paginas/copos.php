...
<html lang="pt">
  ...
  <section class="depoimento text-center style" style="padding">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <h3><img src="../img/img/copos/08.jpeg" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Copo 750ml Cores</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 15,70</h3>
          <br/>
        </div>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/copos/02.jpg" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Copo 550ml Branco</h4>
          <h5>30 Unidades</h5>
          <h3>R$ 24,50</h3>
          <br/>
        </div>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/copos/35.webp" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Copo 750ml Azul</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 15,70</h3>
          <br/>
        </div>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/copos/27.jpg" class="d-block w-100" width="128" height="260">
          </h3>
          <h4>Copo 550ml</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 21,50</h3>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/copos/36.jpg" class="d-block w-100" width="150" height="260">
          </h3>
          <h4>Copo 550ml</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 33,00</h3>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/copos/26.jpg" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Copo 550ml</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 10,50</h3>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/copos/34.webp" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Copo 550ml</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 24,50</h3>
  ...
  <!---rodapé--->
  <footer class="text-center text-white" style="background-color: #f1f1f1;" id="cont">
